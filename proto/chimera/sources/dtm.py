...
class SingleCellFeaturePredictedGeneExpressionPrior(torch.nn.Module):
    EPS = 1e-6
    ...
    def forward(self,
                normalized_cell_features_nf: torch.Tensor,
