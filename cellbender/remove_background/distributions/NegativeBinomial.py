...
class TorchNegativeBinomial(Distribution):
    ...
    Args:
        total_count (float or Tensor): non-negative number of negative Bernoulli
            ...
            valued count
        probs (Tensor): Event probabilities of success in the half open
            interval [0, 1)
        logits (Tensor): Event log-odds for probabilities of success

    Note:
        If you want to parameterize the distribution by mean, mu, and
        overdispersion, phi, then pass in total_count = 1/phi,
        logits = torch.log(mu*phi).
    ...
    def __init__(self, total_count, probs=None, logits=None,
        ...
        super(TorchNegativeBinomial, self).__init__(batch_shape,
    ...
    def expand(self, batch_shape, _instance=None):
        ...
        super(TorchNegativeBinomial, new).__init__(batch_shape,
                                                   validate_args=False)
