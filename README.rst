...
Please refer to `the documentation <https://cellbender.readthedocs.io/en/latest/>`_ for a quick start tutorial.
   ...
   We recommend using v0.3.2 or higher. The codebase has been revitalized and updated in v0.4.0, and we recommend using 
   that or higher for all new analyses. The algorithm remains the same as in the paper for versions v0.3.0, v0.3.2,
   and v0.4.0. Completely identical, just codebase updates. Version v0.5.0 will use a very slight tweak in 
   MKCP estimation to improve compute efficiency and reduce memory usage, but again the algorithm is the same.
...
Ensure that your installation is appropriate for your hardware (i.e. that
...
If you're unable to access that, see also `our preprint on bioRxiv <https://doi.org/10.1101/791699>`_.
