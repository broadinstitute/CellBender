...
The HTML report is generated by executing a Jupyter notebook, which pulls in a
large dependency tree. Those packages are therefore optional. To generate
reports, install
...
Everything else, including the count matrices and the summary PDF, is produced
by the base install.
